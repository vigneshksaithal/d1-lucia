// ../../.wrangler/tmp/bundle-TXkp5r/checked-fetch.js
...
var TimeSpan;
var init_dist = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/index.js"() {
...
var init_bytes = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/bytes.js"() {
  }
});
...
var init_encoding = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/encoding/index.js"() {
    init_bytes();
  }
});
var init_ecdsa = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/crypto/ecdsa.js"() {
  }
});
var init_hmac = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/crypto/hmac.js"() {
  }
});
var init_rsa = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/crypto/rsa.js"() {
  }
});
var init_sha = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/crypto/sha.js"() {
  }
});
...
var init_random = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/crypto/random.js"() {
    init_bytes();
  }
});
...
var init_buffer = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/crypto/buffer.js"() {
  }
});
var init_crypto = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/crypto/index.js"() {
    init_ecdsa();
    init_hmac();
    init_rsa();
    init_sha();
...
async function scrypt(password, salt, options2) {
  const { N, r: r3, p } = options2;
  ...
  for (let pi = 0; pi < p; pi++) {
    ...
    for (let i = 0, pos = 0; i < N - 1; i++) {
      ...
      await new Promise((r4) => r4());
    }
    BlockMix(V, (N - 1) * blockSize32, B32, Pi, r3);
    for (let i = 0; i < N; i++) {
      const j = B32[Pi + blockSize32 - 16] % N;
      for (let k = 0; k < blockSize32; k++) {
        tmp[k] = B32[Pi + k] ^ V[j * blockSize32 + k];
      }
      BlockMix(tmp, 0, B32, Pi, r3);
      await new Promise((r4) => r4());
    }
  }
...
async function pbkdf2(password, salt, options2) {
...
function BlockMix(input, ii, out, oi, r3) {
  ...
  let tail = oi + 16 * r3;
  for (let i = 0; i < 16; i++)
    out[tail + i] = input[ii + (2 * r3 - 1) * 16 + i];
  for (let i = 0; i < r3; i++, head += 16, ii += 16) {
...
var init_scrypt = __esm({
  "node_modules/.pnpm/lucia@3.0.1/node_modules/lucia/dist/scrypt/index.js"() {
  }
});
...
var init_crypto2 = __esm({
  "node_modules/.pnpm/lucia@3.0.1/node_modules/lucia/dist/crypto.js"() {
    init_encoding();
    init_crypto();
    init_scrypt();
    Scrypt = class {
      async hash(password) {
        ...
        const key2 = await generateScryptKey(password.normalize("NFKC"), salt);
        return `${salt}:${encodeHex(key2)}`;
      }
      async verify(hash2, password) {
        const parts = hash2.split(":");
        if (parts.length !== 2)
          return false;
        const [salt, key2] = parts;
        const targetKey = await generateScryptKey(password.normalize("NFKC"), salt);
        return constantTimeEqual(targetKey, decodeHex(key2));
      }
    };
  }
});
...
var init_cookie = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/cookie/index.js"() {
...
var Lucia;
var init_core = __esm({
  "node_modules/.pnpm/lucia@3.0.1/node_modules/lucia/dist/core.js"() {
    init_dist();
    init_crypto2();
    init_cookie();
    Lucia = class {
      ...
      getUserAttributes;
      sessionCookieName;
      constructor(adapter, options2) {
        this.adapter = adapter;
        this.getUserAttributes = (databaseUserAttributes) => {
          if (options2 && options2.getUserAttributes) {
            return options2.getUserAttributes(databaseUserAttributes);
          }
          return {};
        };
        this.getSessionAttributes = (databaseSessionAttributes) => {
          if (options2 && options2.getSessionAttributes) {
            return options2.getSessionAttributes(databaseSessionAttributes);
          }
          return {};
        };
        this.sessionExpiresIn = options2?.sessionExpiresIn ?? new TimeSpan(30, "d");
        this.sessionCookieName = options2?.sessionCookie?.name ?? "auth_session";
        let sessionCookieExpiresIn = this.sessionExpiresIn;
        if (options2?.sessionCookie?.expires === false) {
        ...
        const baseSessionCookieAttributes = {
          ...
          sameSite: "lax",
          path: "/",
          ...options2?.sessionCookie?.attributes
        };
      ...
      async createSession(userId, attributes, options2) {
        const sessionId = options2?.sessionId ?? generateId(40);
...
var init_request = __esm({
  "node_modules/.pnpm/oslo@1.0.1/node_modules/oslo/dist/request/index.js"() {
  }
});
var init_dist2 = __esm({
  "node_modules/.pnpm/lucia@3.0.1/node_modules/lucia/dist/index.js"() {
    init_core();
    init_crypto2();
    init_dist();
    init_cookie();
...
var SQLiteAdapter;
var init_base = __esm({
  "node_modules/.pnpm/@lucia-auth+adapter-sqlite@3.0.0_lucia@3.0.1/node_modules/@lucia-auth/adapter-sqlite/dist/base.js"() {
    SQLiteAdapter = class {
      controller;
...
var init_better_sqlite3 = __esm({
  "node_modules/.pnpm/@lucia-auth+adapter-sqlite@3.0.0_lucia@3.0.1/node_modules/@lucia-auth/adapter-sqlite/dist/drivers/better-sqlite3.js"() {
    init_base();
  }
});
var D1Adapter;
var D1Controller;
var init_d1 = __esm({
  "node_modules/.pnpm/@lucia-auth+adapter-sqlite@3.0.0_lucia@3.0.1/node_modules/@lucia-auth/adapter-sqlite/dist/drivers/d1.js"() {
    init_base();
    D1Adapter = class extends SQLiteAdapter {
    ...
    D1Controller = class {
      ...
      async get(sql, args) {
        return await this.db.prepare(sql).bind(...args).first();
      }
...
var init_libsql = __esm({
  "node_modules/.pnpm/@lucia-auth+adapter-sqlite@3.0.0_lucia@3.0.1/node_modules/@lucia-auth/adapter-sqlite/dist/drivers/libsql.js"() {
    init_base();
  }
});
var init_bun_sqlite = __esm({
  "node_modules/.pnpm/@lucia-auth+adapter-sqlite@3.0.0_lucia@3.0.1/node_modules/@lucia-auth/adapter-sqlite/dist/drivers/bun-sqlite.js"() {
    init_base();
  }
});
var init_dist3 = __esm({
  "node_modules/.pnpm/@lucia-auth+adapter-sqlite@3.0.0_lucia@3.0.1/node_modules/@lucia-auth/adapter-sqlite/dist/index.js"() {
    init_better_sqlite3();
    init_d1();
    init_libsql();
    init_bun_sqlite();
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.CdTBICOq.js", "_app/immutable/chunks/scheduler.BLLGogQX.js", "_app/immutable/chunks/index.BaR5Nm0C.js"];
    stylesheets = [];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.DTRY_S6W.js", "_app/immutable/chunks/scheduler.BLLGogQX.js", "_app/immutable/chunks/index.BaR5Nm0C.js", "_app/immutable/chunks/entry.BdCbmOOU.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1 data-svelte-h="svelte-yyjjjs">Welcome to SvelteKit</h1> <p data-svelte-h="svelte-a64301">Visit <a href="https://kit.svelte.dev">kit.svelte.dev</a> to read the documentation</p>`;
    });
  }
});
var __exports3 = {};
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.Bno9w9r2.js", "_app/immutable/chunks/scheduler.BLLGogQX.js", "_app/immutable/chunks/index.BaR5Nm0C.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var init_page_server_ts = __esm({
  ".svelte-kit/output/server/entries/pages/signup/_page.server.ts.js"() {
    init_auth();
    init_chunks();
    init_dist2();
    actions = {
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/signup/_page.svelte.js"() {
    ...
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1 data-svelte-h="svelte-13vjqy4">Sign up</h1> <form method="post" data-svelte-h="svelte-hcoop7"><label for="username">Username</label> <input name="username" id="username"><br> <label for="password">Password</label> <input type="password" name="password" id="password"><br> <button>Continue</button></form>`;
    });
  }
});
var __exports4 = {};
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    server_id = "src/routes/signup/+page.server.ts";
    imports4 = ["_app/immutable/nodes/3.Dad16vKR.js", "_app/immutable/chunks/scheduler.BLLGogQX.js", "_app/immutable/chunks/index.BaR5Nm0C.js", "_app/immutable/chunks/entry.BdCbmOOU.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});
...
var manifest = (() => {
  ...
  return {
    ...
    _: {
      client: { "start": "_app/immutable/entry/start.CrSYvfse.js", "app": "_app/immutable/entry/app.CFVLDPI2.js", "imports": ["_app/immutable/entry/start.CrSYvfse.js", "_app/immutable/chunks/entry.BdCbmOOU.js", "_app/immutable/chunks/scheduler.BLLGogQX.js", "_app/immutable/entry/app.CFVLDPI2.js", "_app/immutable/chunks/scheduler.BLLGogQX.js", "_app/immutable/chunks/index.BaR5Nm0C.js"], "stylesheets": [], "fonts": [], "uses_env_dynamic_public": false },
      nodes: [
...
// ../../../../../../../opt/homebrew/Cellar/cloudflare-wrangler2/3.28.1/libexec/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../../.wrangler/tmp/bundle-TXkp5r/middleware-insertion-facade.js
...
// ../../../../../../../opt/homebrew/Cellar/cloudflare-wrangler2/3.28.1/libexec/lib/node_modules/wrangler/templates/middleware/common.ts
...
// ../../.wrangler/tmp/bundle-TXkp5r/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.9971510859186363.mjs.map
