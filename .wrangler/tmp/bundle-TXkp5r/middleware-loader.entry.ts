...
import worker from "/Users/vigneshks/Documents/GitHub/d1-lucia/.wrangler/tmp/bundle-TXkp5r/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/opt/homebrew/Cellar/cloudflare-wrangler2/3.28.1/libexec/lib/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/Users/vigneshks/Documents/GitHub/d1-lucia/.wrangler/tmp/bundle-TXkp5r/middleware-insertion-facade.js";
